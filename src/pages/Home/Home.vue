  ...
  <div class="first">
    <div class="home">
      ...
      <section class="GoodSale">
        ...
        <div class="goods">
          <ul>
            <li v-for="(name,index) in newHome" :key="index">
              <a href="javascript:;">
                <div class="ctn">
                  <span class="title">{{name.name}}</span>
                  <span class="proce">{{name.floorPrice}}起</span>
                </div>
                <img :src="name.appListPicUrl" alt="">
              </a>
            </li>
          </ul>
        </div>
...
<script>
  ...
  export default {
    ...
    mounted(){
      ...
      new BScroll('.first',{click:true,scrollY:true})
